...
import { getOpcionPreguntaById, getOpcionesPreguntasByPreguntaId, patchSaveOpcionPregunta, postSaveOpcionPregunta } from "../../services/OpcionesPreguntasService";
import { OPCIONESPREGUNTAS_LIST_URL } from "../../navigation/CONSTANTS";
import Menu from "../../components/Menu";
import { Form, Button, Card, Container } from "react-bootstrap";

const PreguntaFormOpcion = () => {
    const { id } = useParams();
                        ...
                        <div>
                            ...
                            <Form noValidate validated={validated} onSubmit={onOpcionesPreguntaFormSubmit}>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Select onChange={onChangePregunta} value={pregunta_id} required disabled>
...
export default PreguntaFormOpcion;